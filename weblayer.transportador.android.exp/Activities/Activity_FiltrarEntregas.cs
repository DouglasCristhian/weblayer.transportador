...
namespace weblayer.transportador.android.exp.Activities
{
    ...
    public class Activity_FiltrarEntregas : Activity_Base
    {
        ...
        private List<mySpinner> PopulateSpinner()
        {
            ...
            minhalista.Add(new mySpinner(0, "Todas as entregas"));
            minhalista.Add(new mySpinner(1, "Entregas incluídas hoje"));
            minhalista.Add(new mySpinner(2, "Entregas incluídas esta semana"));
            minhalista.Add(new mySpinner(3, "Entregas incluídas este mês"));
